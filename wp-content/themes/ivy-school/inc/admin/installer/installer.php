		...
		public function prepare_installation() {
			...
			<div class="install-container text-center">
				<button class="thim-button-link button button-primary"
						data-href="<?php echo esc_url( $link ) ?>"><?php esc_html_e( 'Install and Activate', 'ivy-school' ) ?></button>
				<a class="button button-secondary"
				   href="<?php echo esc_url( admin_url() ) ?>"><?php esc_html_e( 'Skip', 'ivy-school' ) ?></a>
			</div>
			<?php
		}
			...
			<div class="notice notice-error">
				...
				<p>
					<button data-href="<?php echo esc_url( $link ) ?>"
							class="thim-button-link button button-primary"><?php esc_html_e( 'Activate again', 'ivy-school' ) ?></button>
				</p>
			</div>
